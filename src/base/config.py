...
NGINX_WWW_DIR = f"{RAINB0W_HOME_DIR}/nginx/html"
NGINX_USERS_DIR = f"{NGINX_WWW_DIR}/users"
NGINX_CONFIG_FILE = f"{RAINB0W_HOME_DIR}/nginx/etc/nginx.conf"
NGINX_HTPASSWD_FILE = f"{RAINB0W_HOME_DIR}/nginx/etc/.htpasswd"
NGINX_SHARE_PAGE_TEMPLATE_FILE = f"{RAINB0W_HOME_DIR}/nginx/templates/user-share-links.html"
